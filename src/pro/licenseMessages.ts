...
export const LICENSE_ERROR_MESSAGES: Record<LicenseErrorCode, string> = {
  ...
  'license-inactive':
    'Diese Pro-Lizenz ist nicht aktiv, zum Beispiel nach einer Kündigung. Audience Live läuft im Free-Modus weiter.',
  ...
  'invalid-response': 'Die Antwort des Lizenzservers konnte nicht bestätigt werden. Bitte aktualisiere Audience Live.',
  'secret-storage':
