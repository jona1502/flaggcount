...
export const metadata = pageMetadata({
  ...
  description: 'Aktivierungscode für Audience Live Pro verloren? Fordere einen neuen Code an die E-Mail-Adresse des Kaufs an.',
  ...
  return (
    <PageShell>
      <section className="landing-section narrow-section" aria-labelledby="recovery-title">
        ...
        <p className="lead">
          Gib die E-Mail-Adresse ein, mit der du Audience Live Pro gekauft hast. Wir schicken dir einen neuen Aktivierungscode; frühere Codes werden
