...
- Die Übersicht ist die Startseite: Verbinden, offene Einrichtungsschritte und alle laufenden Runden auf einer Seite. Hinweise auf Pro-Funktionen sind kompakter.
...
- Neue **Live-Ansicht**: Eine feste Live-URL (`/overlay/live`) kommt einmal in OBS oder TikTok LIVE Studio; Szenen werden danach mit einem Klick live geschaltet oder das Overlay ausgeblendet – auch aus der Übersicht. Die Bühne zeigt mit der echten Overlay-Darstellung schon vor dem Speichern, was im Stream erscheint.
- Szenen zeigen mehrere Elemente zusammen, mehrere Abstimmungen oder dasselbe Element mehrfach in eigener Größe, angeordnet über Layout, Position im Bild, Größe und Abstand. Einfache Zähler zeigen im Overlay ihr eigenes Emoji. Gespeicherte Overlay-Ansichten werden automatisch zu Szenen (Einstellungsschema 5, mit Backup).
- Die Overlays-Seite hält Liste und Editor nebeneinander und erklärt, wenn für eine gemeinsame Anzeige ein zweites Element fehlt.
